...
for epoch in range(0, num_epochs):
    ...
    for idx, data in enumerate(dataloader):
        ...
        prob_sf_pred = Disc(disc_input_pred)
        prob_sf_real = Disc(disc_input_real)
        ...
        disc_loss = criterion_d(prob_sf_pred.detach(), FAKE_t) + criterion_d(prob_sf_real.detach(), REAL_t)
        gen_adv_loss = criterion_d(prob_sf_pred, REAL_t)
